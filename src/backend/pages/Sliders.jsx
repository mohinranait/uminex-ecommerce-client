...
import BannerRows from "../components/TableRows/BannerRows";
...
const Sliders = () => {
    ...
    const handleGetBannerId = async (id) => {
        ...
        <>
            <div className="bg-white px-5 py-5">
                <div className="flex justify-between items-center gap-5 mb-5">
                    ...
                    <button onClick={openModal} className="flex gap-1 items-center py-2 px-3 bg-primary text-white rounded text-sm"><IoAddOutline />Add banner</button>
                </div>
                <hr />
                <div className="overflow-x-auto">
                    <table className="w-full border-collapse">
                        ...
                        <tbody>
                            {
                                banners?.map((banner, index) => <BannerRows key={banner?._id} index={index} refetch={refetch} handleGetBannerId={handleGetBannerId} banner={banner}  /> )
                            }
                    ...
                    {
                        banners?.length == 0 && <div className="py-3 px-5 bg-blue-50 text-blue-600 rounded mt-5 text-center">
            ...
            <Modal isOpenModal={isOpenModal} width={'30'} closeModal={closeModal} >
                <div className="w-[95vw] lg:w-[40vw]">
                   <BannerForm banner={banner} refetch={refetch} closeModal={closeModal} />
                </div>
            </Modal>
        </>
    );
